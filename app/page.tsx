    ...
    <main className="relative min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-[var(--teal-50)] dark:bg-[var(--teal-950)] text-[var(--teal-900)] dark:text-[var(--teal-100)]">
      ...
      <section className="text-center z-10">
        <div className="flex flex-col items-center">
          <h1 className="text-7xl sm:text-8xl md:text-9xl font-black tracking-tighter mb-8 font-sans">NourishNote</h1>
          <div className="h-12 flex items-center">
            <p className="text-2xl sm:text-3xl md:text-4xl text-[var(--teal-600)] dark:text-[var(--teal-300)] overflow-hidden whitespace-nowrap border-r-4 border-r-[var(--teal-500)] animate-typing">
              Built to inspire for mindful living.
            </p>
          </div>
